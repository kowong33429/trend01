...
//---
   ...
   //double trend_fast_up = iCustom(NULL,0,"Non_Repainting_SuperTrend",10,1.0,0,1);
   //double trend_meduim_up = iCustom(NULL,0,"Non_Repainting_SuperTrend",11,2.0,0,1);
   //double trend_slow_up = iCustom(NULL,0,"Non_Repainting_SuperTrend",12,3.0,0,1);

   //double trend_fast_down = iCustom(NULL,0,"Non_Repainting_SuperTrend",10,1.0,1,1);
   //double trend_meduim_down = iCustom(NULL,0,"Non_Repainting_SuperTrend",11,2.0,1,1);
   //double trend_slow_down = iCustom(NULL,0,"Non_Repainting_SuperTrend",12,3.0,1,1);
   
   
   if((TimeMinute(TimeCurrent()) == 1 || TimeMinute(TimeCurrent()) == 31) && TimeSeconds(TimeCurrent()) == 1)
     {
      Print("0: ",iCustom(NULL,0,"Non_Repainting_SuperTrend",0,1)," 1: ",iCustom(NULL,0,"Non_Repainting_SuperTrend",1,1),
            "2: ",iCustom(NULL,0,"Non_Repainting_SuperTrend",2,1)," 3: ",iCustom(NULL,0,"Non_Repainting_SuperTrend",3,1));
     }
/*
