...
//---
   ...
   double ema_7 = iMA(_Symbol,PERIOD_M5,7,8,MODE_EMA,PRICE_CLOSE,1);
   double ema_20 = iMA(_Symbol,PERIOD_M5,20,8,MODE_EMA,PRICE_CLOSE,1);
   double close_day = iClose(_Symbol,PERIOD_D1,0);
   double open_day = iClose(_Symbol,PERIOD_D1,0);
  }
